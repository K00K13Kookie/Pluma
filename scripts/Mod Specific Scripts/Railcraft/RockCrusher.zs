...
RockCrusher.add(<undergroundbiomes:metamorphic_stone:6>, [<undergroundbiomes:metamorphic_cobble:6>, <nuclearcraft:dust:7>], [1, 0.10], 200);
...
RockCrusher.add(<undergroundbiomes:igneous_stone:4>, [<undergroundbiomes:igneous_cobble:4>, <gregtech:meta_item_1:2226>], [1, 0.15], 200);

//Komatiite producing Aluminum and Magnesium
RockCrusher.add(<undergroundbiomes:igneous_stone:6>, [<undergroundbiomes:igneous_cobble:6>, <thermalfoundation:material:68>, <nuclearcraft:dust:7>], [1, 0.10, 0.05], 300);
...
RockCrusher.add(<undergroundbiomes:metamorphic_stone:3>, [<undergroundbiomes:metamorphic_cobble:3>, <nuclearcraft:gem_dust:2>, <actuallyadditions:item_dust:7>], [1, 0.15, 0.15], 300);

//Limestone producing Iron Dust 
RockCrusher.add(<ore:stoneLimestone>, [<pyrotech:cobblestone:3>, <thermalfoundation:material>], [1, 0.10], 200);
...
RockCrusher.add(<undergroundbiomes:sedimentary_stone:5>, [<thermalfoundation:material>, <nuclearcraft:dust:7>], [0.15, 0.15], 200);
...
RockCrusher.add(<undergroundbiomes:metamorphic_stone:4>, [<undergroundbiomes:metamorphic_cobble:4>, <gregtech:meta_item_1:2008>], [1, 0.13], 200);

//Green Schist producing Bismuth
RockCrusher.add(<undergroundbiomes:metamorphic_stone:5>, [<undergroundbiomes:metamorphic_cobble:5>, <gregtech:meta_item_1:2008>], [1, 0.10], 250);
