...
//Thanks Multiblock Madness Devs!
...
<ore:rawStainlessSteel>.firstItem:
[
"400 ppc Iron",
"300 ppc Invar",
"100 ppc Chrome",
...
for alloyItem, componentStrs in alloyComponentStrsMap {
	alloyItem.addTooltip(format.gold("Hold Shift for the Metal Alloyer Composition:"));
	for str in componentStrs {
		alloyItem.addShiftTooltip(format.lightPurple(str));
	}
}

// Profiling Bench Tooltip

<rockhounding_chemistry:machines_a:11>.addTooltip(format.gold("A Special Bench for making Coins, Special Casings and Rockhounding Catalysts"));
