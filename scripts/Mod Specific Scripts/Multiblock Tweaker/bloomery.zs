    ...
    .withPattern(
        FactoryBlockPattern.start(RelativeDirection.RIGHT, RelativeDirection.DOWN, RelativeDirection.FRONT)
            ...
            .aisle(
                ...
                "CCC")
            .whereOr("C",
                <metastate:minecraft:red_nether_brick>,
            ...
            .where("A", <metastate:railcraft:glass:14>)
            .where("B", <metastate:chisel:antiblock:1>)
    ...
    .addDesign(
        FactoryMultiblockShapeInfo.start()
            ...
            .aisle(
                ...
                "CCC",
                "FCC")
            .where("C", <metastate:minecraft:red_nether_brick>)
            .where("A", <metastate:railcraft:glass:14>)
            .where("B", <metastate:chisel:antiblock:1>)
